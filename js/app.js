...
function ready() {
    ...
    var addToCartButtons = document.getElementsByClassName('btn-danger')
...
function addToCartClicked(event) {
    ...
    var title = foodItem.getElementsByClassName('dishname')[0].innerText
    var price = foodItem.getElementsByClassName('amount')[0].innerText
